    ...
    0.52), #000000), url(${bannerBg})`,
      ...
      >
        ...
        <div className="hero-content text-center text-white grid items-center justify-center lg:grid-cols-2 rounded-lg">
          <img
            src="https://i.ibb.co/YLp1DX1/p.jpg"
            alt="myProfile"
          ...
          <article className="lg:text-left lg:-ml-[170px] lg:w-[60vw] pr-5">
            <Zoom>
              <h1 className="mb-5 text-5xl font-bold mt-10 text-emerald-500">
                Hi! <span className="text-white">I'm Nazmul Bhuyian</span>
              </h1>
            </Zoom>
            ...
            <div className="lg:w-[38em]">
              <p className="mb-5">
                I am a skilled Mern Stack developer. Always I prefer hand coded
                organized programming. I love to learn new technology and want
                to make peoples life easy with programming.
              </p>
            </div>
            <div className="flex mb-5 justify-center lg:justify-start">
              <a
                className="p-4 text-xl ml-5 lg:ml-0 rounded-full hover:bg-emerald-500"
                style={{ boxShadow: "2px 3px 12px gray" }}
                href="mailto:nazmulbhuyian000@gmail.com"
              >
                <FaEnvelope />
              </a>
              <a
                rel="noreferrer"
                className="p-4 text-xl ml-5 rounded-full hover:bg-emerald-500"
                style={{ boxShadow: "2px 3px 12px gray" }}
                href="https://web.facebook.com/nazmul.nobel.3"
                target="_blank"
              >
                <FaFacebookF />
              </a>
              <a
                ...
                className="p-4 text-xl ml-5 rounded-full hover:bg-emerald-500"
                style={{ boxShadow: "2px 3px 12px gray" }}
                href="https://www.linkedin.com/in/nazmul-bhuyian-mern-stack-developer/"
                target="_blank"
              >
                <FaLinkedinIn />
              </a>
              <a
                ...
                className="p-4 text-xl ml-5 rounded-full hover:bg-emerald-500"
                style={{ boxShadow: "2px 3px 12px gray" }}
                href="https://github.com/nazmulbhuyian"
                target="_blank"
              >
                <FaGithub />
              </a>
